...
const enBase = {
  ...
  food: {
    title: "Food",
    subtitle: "Browse the shared food database and manage your own food items with macro values per 100 g.",
    ...
    userProductsDescription: "Create your own food items, edit them, and delete them without changing the shared database. All macro values are stored per 100 g.",
    productsListTitle: "Products list",
    productsListDescription: "Macros from the shared database are available to all users in read-only mode and are shown per 100 g.",
    yourListTitle: "Your list",
    yourListDescription: "Food items available only to you with macro values per 100 g.",
    search: "Search",
    generalSearchPlaceholder: "Search the shared food database...",
    userSearchPlaceholder: "Search your foods...",
    product: "Product",
    proteins: "Protein per 100 g",
    fats: "Fat per 100 g",
    carbs: "Carbs per 100 g",
    caloriesPerGram: "Calories per 100 g",
    valuesPer100gHint: "Enter all macro values per 100 g of product.",
    loadingOptions: "Loading options...",
    loadOptionsError: "Failed to load the product list.",
    selectProduct: "Select a product",
    searchProduct: "Search product",
    productSectionTitle: "Choose a product",
    productSearchHint: "Start typing the product name and pick one matching item from the list.",
    selectedProduct: "Selected",
    macroSectionTitle: "Macro values",
    selectProductForValidation: "Select a product",
    enterValue: "Enter {{label}}",
    invalidNumber: "Enter a valid number",
    negativeValue: "Value cannot be negative",
    createDialogDescription: "Find the product in the dictionary and fill in macro values per 100 g.",
    editDialogDescription: "Update the selected product and adjust macro values per 100 g.",
...
const enExtensions = {
  ...
  admin: {
    ...
    foodsPage: {
      title: "Food",
      subtitle:
        "Manage the shared food database. These entries are available to users as read-only items in the Food section and store macros per 100 g.",
      addProduct: "Add product",
      searchTitle: "Search",
      searchDescription:
      ...
      databaseDescription:
        "Creating, editing, and deleting `GeneralFood` is only available in the admin panel. Macro values are stored per 100 g.",
